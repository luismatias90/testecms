...
var listaEmpresa = [
    ...
    {
        tipo: 5,
        atividade: 'Blogger/Youtuber/etc',
    ...
    {
        tipo: 6,
        atividade: 'Consultoria Empresas',
    ...
    {
        tipo: 7,
        atividade: 'Consultoria Tecnologia',
    ...
    {
        tipo: 8,
        atividade: 'Corretagem de Imóveis',
    ...
    {
        tipo: 9,
        atividade: 'Corretagem de Seguros',
    ...
    {
        tipo: 11,
        atividade: 'Design de Interiores',
    ...
    {
        tipo: 16,
        atividade: 'Estúdio Cinematográficos',
    ...
    {
        tipo: 18,
        atividade: 'Jornalismo e Assessoria',
        denominacao: 'Agências de notícias',
        codigo: '6391-7/00',
        simples: true,
        aliquota_inicial: '6%'
    ...
    {
        tipo: 22,
        atividade: 'Organização e Promoção de Eventos',
    ...
    {
        tipo: 26,
        atividade: 'Salas de Acesso à Internet',
    ...
    {
        tipo: 28,
        atividade: 'Serviços de Lavagem Automotiva',
