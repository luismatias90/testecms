SimuladorApp.controller('listaCnaeController', ['$scope', function ($scope) {
    ...
    $scope.escolheTipoEmpresa = function (tipoEmpresa) {
        ...
        if (tipoEmpresa == 0 || tipoEmpresa == 32) {
            $scope.step1 = false;
        } else {
            $scope.step1 = true
        }
...
{tipo:24, atividade: 'Médicos', denominacao:'Atividades de atendimento hospitalar, exceto pronto-socorro e unidades para atendimento a urgências', codigo: '8610-1/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:24, atividade: 'Médicos', denominacao:'Atividade médica ambulatorial com recursos para realização de procedimentos cirúrgicos', codigo: '8630-5/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:24, atividade: 'Médicos', denominacao:'Atividade médica ambulatorial com recursos para realização de exames complementares', codigo: '8630-5/02', simples: true, aliquota_inicial: '16,93%'},
{tipo:24, atividade: 'Médicos', denominacao:'Atividade médica ambulatorial restrita a consultas', codigo: '8630-5/03', simples: true, aliquota_inicial: '16,93%'},
{tipo:25, atividade: 'Música', denominacao:'Ensino de música', codigo: '8592-9/03', simples: true, aliquota_inicial: '6%'},
{tipo:25, atividade: 'Música', denominacao:'Atividades de gravação de som e de edição de música', codigo: '5920-1/00', simples: true, aliquota_inicial: '6%'},
{tipo:25, atividade: 'Música', denominacao:'Serviços de dublagem', codigo: '5912-0/01', simples: true, aliquota_inicial: '6%'},
{tipo:25, atividade: 'Música', denominacao:'Serviços de mixagem sonora em produção audiovisual', codigo: '5912-0/02', simples: true, aliquota_inicial: '6%'},
{tipo:26, atividade: 'Nutrição', denominacao:'Atividades de profissionais da nutrição', codigo: '8650-0/02', simples: true, aliquota_inicial: '16,93%'},
{tipo:27, atividade: 'Organização e Promoção de Eventos', denominacao:'Serviços de organização de feiras, congressos, exposições e festas', codigo: '8230-0/01', simples: true, aliquota_inicial: '6%'},
{tipo:27, atividade: 'Organização e Promoção de Eventos', denominacao:'Casas de festas e eventos', codigo: '8230-0/02', simples: true, aliquota_inicial: '6%'},
{tipo:28, atividade: 'Psicologia', denominacao:'Atividades de psicologia e psicanálise', codigo: '8650-0/03', simples: true, aliquota_inicial: '16,93%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Agenciamento de espaços para publicidade, exceto em veículos de comunicação', codigo: '7312-2/00', simples: true, aliquota_inicial: '6%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Promoção de vendas', codigo: '7319-0/02', simples: true, aliquota_inicial: '6%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Marketing direto', codigo: '7319-0/03', simples: true, aliquota_inicial: '6%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Outras atividades de publicidade não especificadas anteriormente', codigo: '7319-0/99', simples: true, aliquota_inicial: '6%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Agências de notícias', codigo: '6391-7/00', simples: true, aliquota_inicial: '6%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Web design', codigo: '6201-5/02', simples: true, aliquota_inicial: '19,5%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Agências de publicidade', codigo: '7311-4/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Criação de estandes para feiras e exposições', codigo: '7319-0/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Consultoria em publicidade', codigo: '7319-0/04', simples: true, aliquota_inicial: '16,93%'},
{tipo:29, atividade: 'Publicidade e Propaganda', denominacao:'Pesquisas de mercado e de opinião pública', codigo: '7320-3/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:30, atividade: 'Recursos Humanos', denominacao:'Treinamento em desenvolvimento profissional e gerencial', codigo: '8599-6/04', simples: true, aliquota_inicial: '6%'},
{tipo:30, atividade: 'Recursos Humanos', denominacao:'Atividades de consultoria em gestão empresarial, exceto consultoria técnica específica', codigo: '7020-4/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de veículos automotores', codigo: '4512-9/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de peças e acessórios novos e usados para veículos automotores', codigo: '4530-7/06', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de motocicletas e motonetas, peças e acessórios', codigo: '4542-1/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de matérias-primas agrícolas e animais vivos', codigo: '4611-7/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de combustíveis, minerais, produtos siderúrgicos e químicos', codigo: '4612-5/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de madeira, material de construção e ferragens', codigo: '4613-3/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de máquinas, equipamentos, embarcações e aeronaves', codigo: '4614-1/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de eletrodomésticos, móveis e artigos de uso doméstico', codigo: '4615-0/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de têxteis, vestuário, calçados e artigos de viagem', codigo: '4616-8/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de produtos alimentícios, bebidas e fumo', codigo: '4617-6/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de medicamentos, cosméticos e produtos de perfumaria', codigo: '4618-4/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de instrumentos e materiais odonto-médico-hospitalares', codigo: '4618-4/02', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de jornais, revistas e outras publicações', codigo: '4618-4/03', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Outros representantes comerciais e agentes do comércio especializado em produtos não especificados anteriormente', codigo: '4618-4/99', simples: true, aliquota_inicial: '16,93%'},
{tipo:31, atividade: 'Representação Comercial', denominacao:'Representantes comerciais e agentes do comércio de mercadorias em geral não especializado', codigo: '4619-2/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:32, atividade: 'Salas de Acesso à Internet', denominacao:'Salas de acesso à internet', codigo: '8299-7/07', simples: true, aliquota_inicial: '6%'},
{tipo:32, atividade: 'Salas de Acesso à Internet', denominacao:'Outras atividades de serviços prestados principalmente às empresas não especificadas anteriormente', codigo: '8299-7/99', simples: true, aliquota_inicial: '6%'},
{tipo:32, atividade: 'Salas de Acesso à Internet', denominacao:'Fotocópias', codigo: '8219-9/01', simples: true, aliquota_inicial: '6%'},
{tipo:32, atividade: 'Salas de Acesso à Internet', denominacao:'Preparação de documentos e serviços especializados de apoio administrativo não especificados anteriormente', codigo: '8219-9/99', simples: true, aliquota_inicial: '6%'},
{tipo:33, atividade: 'Salão de Beleza', denominacao:'Cabeleireiros, manicure e pedicure', codigo: '9602-5/01', simples: true, aliquota_inicial: '6%'},
{tipo:33, atividade: 'Salão de Beleza', denominacao:'Outras atividades de tratamento de beleza', codigo: '9602-5/02', simples: true, aliquota_inicial: '6%'},
{tipo:34, atividade: 'Serviços Administrativos', denominacao:'Serviços combinados de escritório e apoio administrativo', codigo: '8211-3/00', simples: true, aliquota_inicial: '6%'},
{tipo:34, atividade: 'Serviços Administrativos', denominacao:'Fotocópias', codigo: '8219-9/01', simples: true, aliquota_inicial: '6%'},
{tipo:34, atividade: 'Serviços Administrativos', denominacao:'Preparação de documentos e serviços especializados de apoio administrativo não especificados anteriormente', codigo: '8219-9/99', simples: true, aliquota_inicial: '6%'},
{tipo:34, atividade: 'Serviços Administrativos', denominacao:'Atividades de cobrança e informações cadastrais', codigo: '8291-1/00', simples: true, aliquota_inicial: '6%'},
{tipo:35, atividade: 'Serviços de Lavagem Automotiva', denominacao:'Serviços de lavagem, lubrificação e polimento de veículos automotores', codigo: '4520-0/05', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Tratamento de dados, provedores de serviços de aplicação e serviços de hospedagem na internet', codigo: '6311-9/00', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Reparação e manutenção de computadores e de equipamentos periféricos', codigo: '9511-8/00', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Portais, provedores de conteúdo e outros serviços de informação na internet', codigo: '6319-4/00', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Treinamento em informática', codigo: '8599-6/03', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Outras atividades de prestação de serviços de informação não especificadas anteriormente', codigo: '6399-2/00', simples: true, aliquota_inicial: '6%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Desenvolvimento de programas de computador sob encomenda', codigo: '6201-5/01', simples: true, aliquota_inicial: '19,5%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Web design', codigo: '6201-5/02', simples: true, aliquota_inicial: '19,5%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Desenvolvimento e licenciamento de programas de computador customizáveis', codigo: '6202-3/00', simples: true, aliquota_inicial: '19,5%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Desenvolvimento e licenciamento de programas de computador não-customizáveis', codigo: '6203-1/00', simples: true, aliquota_inicial: '19,5%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Consultoria em tecnologia da informação', codigo: '6204-0/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:36, atividade: 'Serviços de TI', denominacao:'Suporte técnico, manutenção e outros serviços em tecnologia da informação', codigo: '6209-1/00', simples: true, aliquota_inicial: '16,93%'},
{tipo:37, atividade: 'Tradução', denominacao:'Preparação de documentos e serviços especializados de apoio administrativo não especificados anteriormente', codigo: '8219-9/99', simples: true, aliquota_inicial: '6%'},
{tipo:37, atividade: 'Tradução', denominacao:'Serviços de tradução, interpretação e similares', codigo: '7490-1/01', simples: true, aliquota_inicial: '16,93%'},
{tipo:38, atividade: 'Turismo', denominacao:'Agências de viagens', codigo: '7911-2/00', simples: true, aliquota_inicial: '6%'},
{tipo:38, atividade: 'Turismo', denominacao:'Operadores turísticos', codigo: '7912-1/00', simples: true, aliquota_inicial: '6%'},
{tipo:38, atividade: 'Turismo', denominacao:'Serviços de reservas e outros serviços de turismo não especificados anteriormente', codigo: '7990-2/00', simples: true, aliquota_inicial: '6%'},
{tipo:39, atividade: 'Veterinária', denominacao:'Atividades veterinárias', codigo: '7500-1/00 ', simples: true, aliquota_inicial: '16,93%'}
