...
;(function(window) {
	...
	function createNotes() {
        ...
        var palavrasChaves = ['DAS',  'GPS', 'IRPJ','Guias','Relatórios','DRE','Pró labore'];
...
//            notesElContent += '<div class="note icon">teste</div>';
//		}
//        
        
        for(var i = 0; i < palavrasChaves.length; ++i) {
			// we have 6 different types of symbols (icon--note1, icon--note2 ... icon--note6)
            notesElContent += '<div class="note">'+palavrasChaves[i]+'</div>';
		}
