...
var listaEmpresa = [
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Vestuário e acessórios', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Suprimento de informática', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Artigos cama, mesa e banho', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Instrumentos musicais', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Livros, jornais e revistas', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Papelaria', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Tecidos', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Artigos esportivos', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Óptica', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Calçados', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Equipamentos para escritório', codigo: '-', simples: true, aliquota_inicial: '4%'},
{tipo:"comercio", atividade: 'Comércio eletrônico', denominacao:'Móveis', codigo: '-', simples: true, aliquota_inicial: '4%'},
